...
select substring(FullName,1,CHARINDEX(' ',FullName,1)-1) as FirstName from Students#
select SUBSTRING(fullname, CHARINDEX(' ',fullname,1)+1,CHARINDEX(' ',fullname,CHARINDEX(' ',fullname,1)+1) - CHARINDEX(' ',fullname,1)) as secondname from Students#
select SUBSTRING(fullname,CHARINDEX(' ',fullname,CHARINDEX(' ',fullname,1)+1) +1,len(fullname)-CHARINDEX(' ',fullname,CHARINDEX(' ',fullname,1)+1)) as thirdname from Students#
