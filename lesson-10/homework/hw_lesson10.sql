...
where o.OrderDate between '01/01/2023' and '01/01/2024'

------------------------------------------------------------------

select e.Name, isnull(d.DepartmentName, 'No Department') from Employees e
left join Departments as d on d.DepartmentID=e.DepartmentID

-------------------------------------------------------------------

select s.SupplierName, isnull(p.ProductName, 'Do not supply') from Suppliers as s
left join Products as p on p.SupplierID=s.SupplierID

-------------------------------------------------------------------

select o.OrderID, o.OrderDate, p.PaymentDate, p.Amount from Orders as o
full outer join Payments as p on p.OrderID=o.OrderID

--------------------------------------------------------------------

select e.Name as Manager, m.Name as Employee from Employees as m
left join Employees as e on e.EmployeeID=m.ManagerID
...
select e1.Name, e2.Name, e1.ManagerID from Employees e1
...
select e1.Name as Employee1, e2.Name as Employee2, e1.ManagerID as ManagerID, e1.Salary, e2.Salary  from Employees e1
left join Employees e2 on e2.ManagerID=e1.ManagerID
...
where c.CategoryName in ('Elelctronics','Furniture')	
